...
<head>
    ...
    <title>Bootstrap your platform - {{ config('app.name') }}</title>
    ...
    <div class="card auth-card border-0 rounded-4 shadow-lg">
        <div class="card-body p-4 p-md-5">
            <div class="text-center mb-4">
                <h3 class="mb-1"><i class="fas fa-rocket text-primary"></i> Create the platform owner</h3>
                <p class="text-muted mb-0">This first account becomes the Super Admin of all your gyms.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register.attempt') }}">
                ...
                <button class="btn btn-primary w-100 py-2">Create platform account</button>
            </form>
        </div>
    </div>
</body>
