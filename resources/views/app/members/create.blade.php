...
<div class="card p-4" style="max-width:720px;">
    <form method="POST" action="{{ route('app.members.store') }}">
        @csrf
        <div class="row g-3">
            <div class="col-md-6">
        ...
        <div class="mt-4 d-flex gap-2">
            <button class="btn btn-primary"><i class="fas fa-save me-1"></i> Save Member</button>
            <a href="{{ route('app.members.index') }}" class="btn btn-outline-secondary">Cancel</a>
        </div>
    </form>
</div>
